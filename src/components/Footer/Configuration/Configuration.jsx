...
const Configuration = ({ setActiveModal }) => {
    ...
    return (
        <div className='configuration-datos-personales'>
            <div className="contenedor-configuration">
                ...
                <div className="parte-superior">
                    ...
                    <div className="icono">
                        <IoMdClose className="icon" onClick={() => setActiveModal(false)} />
                    </div>
                </div>
                ...
                <div className="formulario-de-datos-personales">
                    ...
                    <div className="contenedor-de-datos">
                        ...
                        <input
                            ...
                            type="text" placeholder="Perez" className="contenedor-de-datos-input" value={!datosCargados.lastName ? datosPersonales.apellido : datosCargados.lastName} onChange={e => setDatosPersonales({ ...datosPersonales, apellido: e.target.value })} readOnly={datosCargados.lastName} />
                    </div>
                    ...
                    <div className="contenedor-de-datos-privados">
                        <div className="cont-form">
                            ...
                            <input
                                ...
                                type="text" placeholder="18" className="cddp-input" value={!datosCargados.years ? datosPersonales.edad : datosCargados.years} onChange={e => setDatosPersonales({ ...datosPersonales, edad: e.target.value })} readOnly={datosCargados.years} />
                        </div>
                        <div className="cont-form">
