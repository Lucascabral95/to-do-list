...
// src/presentation/components/common/Header/Header.tsx
...
import { GoHistory } from 'react-icons/go';
import { LuPlus } from 'react-icons/lu';
import { Avatar, Spinner, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Input } from '@nextui-org/react';
...
const Header = () => {
  ...
  return (
    <header className="header-raiz">
          ...
          <div className="categorias">
            ...
            >
              <div className="cats">
                ...
                <Link href="/app/bandeja-de-entrada">
                  <div
                    className="icono-nombre"
                    style={{ backgroundColor: categoriaSeleccionada === '/app/bandeja-de-entrada' && 'var(--fondo-hover)' }}
                  >
                    <CiInboxIn className="icon" />
                    <p>Bandeja de entrada</p>
                  </div>
                ...
                <Link href="/app/hoy">
                  <div
                    className="icono-nombre"
                    style={{ backgroundColor: categoriaSeleccionada === '/app/hoy' && 'var(--fondo-hover)' }}
                  >
                    <CiCalendarDate className="icon" />
                    <p>Hoy</p>
                  </div>
                ...
                <Link href="/app/historial-de-tareas">
                  <div
                    className="icono-nombre"
                    style={{ backgroundColor: categoriaSeleccionada === '/app/historial-de-tareas' && 'var(--fondo-hover)' }}
                  >
                    <GoHistory className="icon" />
                    <p>Historial de tareas</p>
                  </div>
                ...
                <div className="proyect-project">
                  ...
                  {arrayProyectos?.map((proyecto) => (
                    <div key={proyecto._id} style={{ width: '100%' }}>
                      <Link href={`/app/nuevo-proyecto/${proyecto?._id}`}>
                        <div className="array-proyectos">
                          <div className="texto">
                            <span>#</span> <p>{proyecto?.project}</p>
                          </div>
                          <div className="basura" onClick={() => eliminarProyecto(proyecto?._id)}>
                            <PiTrashSimple className="icon" />
                          </div>
                        </div>
                      </Link>
                  ...
                  {(onClose) => (
                    <>
                      ...
                      <ModalFooter>
                        ...
                        <Button color="primary" onClick={() => crearProyecto()}>
                          Crear
                        </Button>
                      </ModalFooter>
                    </>
      ...
      {isOpenModalTask && <ModalTaskMobile setIsOpenModalTask={setIsOpenModalTask} />}
      {activeModal && <ConfigurationDesktop setActiveModal={setActiveModal} />}
    </header>
  );
};
